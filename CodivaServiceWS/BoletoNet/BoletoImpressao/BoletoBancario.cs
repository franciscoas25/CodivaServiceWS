...
namespace BoletoNet
{
    ...
    public class BoletoBancario : Control
    {
        ...
        public string GeraHtmlInstrucoes()
        {
            try
            {
                ...
                return html.ToString()
                    ...
                    .Replace("@DEBITO", numeroDebito)
                    .Replace("@DATAATUAL", DateTime.Now.ToShortDateString())
        ...
        protected static void HtmlOfflineHeader(StringBuilder html, bool usaCSSPDF = false, string titulo = "Boleto.Net")
        {
            ...
            #region Css
            {
                string arquivoCSS = usaCSSPDF ? "CodivaServiceWS.BoletoNet.BoletoImpressao.BoletoNetPDF.css" : "CodivaServiceWS.BoletoNet.BoletoImpressao.BoletoNet.css";
        ...
        void GeraGraficosParaEmailOffLine(out LinkedResource lrImagemLogo, out LinkedResource lrImagemBarra, out LinkedResource lrImagemCodigoBarra)
        {
            ...
            Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("CodivaServiceWS.BoletoNet.Imagens." + Utils.FormatCode(_ibanco.Codigo.ToString(), 3) + ".jpg");
        ...
        public void MontaHtmlNoArquivoLocal(string fileName, string nomeAutuado, string cpfCnpjAutuado)
        {
        ...
        public string MontaHtml(string fileName, string logoCedente)
        {
            ...
            //{
            Stream streamLogo = Assembly.GetExecutingAssembly().GetManifestResourceStream("CodivaServiceWS.BoletoNet.Imagens." + Utils.FormatCode(_ibanco.Codigo.ToString(), 3) + ".jpg");
        ...
        public string MontaHtmlEmbedded(bool convertLinhaDigitavelToImage = false, bool usaCSSPDF = false, bool imprimeHeader = true, bool imprimeFooter = true)
        {
            ...
            try
            {
                ...
                streamBarra = assembly.GetManifestResourceStream("CodivaServiceWS.BoletoNet.Imagens.barra.gif");
        ...
        public static byte[] ObterLogoDoBanco(short codigoBanco)
        {
            ...
            {
                var assembly = Assembly.GetExecutingAssembly();
                streamLogo = assembly.GetManifestResourceStream(string.Format("CodivaServiceWS.BoletoNet.Imagens.{0}.jpg", codigoBanco.ToString("000")));
