...
namespace CodivaServiceWS.Service.Interface
{
    public interface IDebitoService
    {
        ...
        (bool sucesso, string urlBoleto, string nossoNumero, double codigoBoletoRegistrado, int numeroGuia) GerarNotificacaoDebito(int codigoDebito, string valorMulta, string dataVencimento, string percentualSelic, string percentualMulta, string valorSelic, string valorMultaSelic);
