...
namespace BoletoNetCore
{
    ...
    public class BoletoBancario
    {
        ...
        {
            var urlImagemLogo = "data:image/jpg;base64," + GetResourceImage("CodivaServiceWS.BoletoNetCore.Imagens." + Utils.FormatCode(Boleto.Banco.Codigo.ToString(), 3) + ".jpg");
            var urlImagemBarra = "data:image/jpg;base64," + GetResourceImage("CodivaServiceWS.BoletoNetCore.Imagens.barra.gif");
        ...
        public string MontaHtmlEmbedded(bool convertLinhaDigitavelToImage = false, bool usaCsspdf = false, string codigoDebito = null, string urlImagemLogoBeneficiario = null, string pixString = null)
        {
            ...
            var streamLogo = assembly.GetManifestResourceStream("CodivaServiceWS.BoletoNetCore.Imagens." + Boleto.Banco.Codigo.ToString("000") + ".jpg");
            ...
            var streamBarra = assembly.GetManifestResourceStream("CodivaServiceWS.BoletoNetCore.Imagens.barra.jpg");
